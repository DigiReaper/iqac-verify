...
class CertificateController extends Controller
{
    ...
    public function createCertificate(Request $request)
    {
        if (Auth::check())
        {
            ...
            $certificate->passport_nid = "NA";
            $certificate->driving_license ="NA";
            $certificate->company = $request->company;
            $certificate->training_name = $request->training_name;
            $certificate->location ="NA";
            $certificate->trainer ="NA";
            $certificate->training_date ="NA";
            $certificate->issue_date = $request->issue_date;
            $certificate->expiry_date ="NA";
    ...
    public function export() 
    {
        if (Auth::check())
        {
            ...
            $fileName = 'MLRIT Certificate DB on '.$today.'.xlsx';
