                    ...
                    <div class="col-md-12 ">
                        <div class="card">
                            <div class="card-header" style="padding-top: 20px; padding-bottom: 20px;">
                                <center><h3>MLRIT Certificate DB</h3></center>
                                    ...
                                    <?php $__currentLoopData = $certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?php echo e($verification_url); ?>" target="_blank" style="margin-bottom: 5px"><i class="fa-solid fa-qrcode" title="Generate QR Code"></i></a>
...
<?php /**PATH D:\xampp\htdocs\certt\resources\views/dashboard.blade.php ENDPATH**/ ?>