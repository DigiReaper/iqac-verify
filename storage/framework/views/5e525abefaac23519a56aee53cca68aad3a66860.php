                    ...
                    <div class="col-md-7 offset-md-3">
                        <div class="card">
                            <div class="card-header" >
                                <center><h3>Add New Certificate</h3></center>
                                <center>
                            ...
                            <div class="card-body">
                                ...
                                <form class="col s12" method="POST" action="<?php echo e(route('certificate.create')); ?>">
                                    ...
                                    <div class="form-group">
                                        <label for="certificate_number">Certificate id*</label>
...
unset($__errorArgs, $__bag); ?>
                                        <input type="text" name="certificate_number" class="form-control" placeholder="Enter Certificate id" value="<?php echo e(old('certificate_number')); ?>">
                                        <br>
...
<!-- 
                                        ...
                                        <label for="training_name">Programme Name*</label>
...
<?php /**PATH D:\xampp\htdocs\certt\resources\views/add-certificate.blade.php ENDPATH**/ ?>