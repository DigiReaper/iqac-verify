  ...
  <body>
    <div class="section wf-section">
      <img
        ...
        width="250"
      />
      <h1 class="heading">Verify MLRIT Certificate</h1>
      <p class="paragraph">
        Enter the Certificate id and click the "Verify"&nbsp;button.
      </p>
      <div class="form-block w-form">
        ...
        >
          <input
            ...
            maxlength="256"
            name="search"
            placeholder="Ex: MLRIT/CERT/2023/09/22"
            id="search"
            required=""
          /><input
            type="submit"
      ...
      <?php if($certificates->count() < 1): ?>
        <h3>❌ The Certificate id You Entered is Invalid or Manipulated. Please contact MLR Institute of Technology for futher inquiry. ❌</h3>
      <?php endif; ?>
      <?php $__currentLoopData = $certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <h3>Certificate Valid! ✅</h3>
        <h3>Certificate ID:&nbsp;<?php echo e($certificate->certificate_number); ?></h3>
        ...
        <h3>Institution:&nbsp;<?php echo e($certificate->company); ?></h3>
        <h3>Programme Name:&nbsp;<?php echo e($certificate->training_name); ?></h3>
...
<?php /**PATH D:\xampp\htdocs\certt\resources\views/verify.blade.php ENDPATH**/ ?>