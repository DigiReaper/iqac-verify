                                    ...
                                    @foreach ($certificates as $certificate)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data={{ $verification_url }}" target="_blank" style="margin-bottom: 5px"><i class="fa-solid fa-qrcode" title="Generate QR Code"></i></a>
